<template>
    <div class="py-16 px-4 sm:px-6 lg:px-8">
        <div class="container mx-auto">
            <div class="flex justify-center items-center flex-col lg:flex-row gap-8 lg:gap-24">
                <!-- Image Section -->
                ...
                <div class="order-1 lg:order-2">
                    <div class="mb-8">
                        <!-- <h3 class="text-gray-600 font-medium text-lg mb-4">Welcome To</h3> -->
                        <h2 class="text-4xl lg:text-5xl font-bold mb-4">
                            <span class="lightText">About</span>
                            <span class="text-gray-900"> Host</span>
                        </h2>
